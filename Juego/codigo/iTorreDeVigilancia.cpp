...
int TorreDeVigilancia::modeloHandler ;

//Crea el cuartel general a partir de su modelo y lo marca como seleccionable
TorreDeVigilancia::TorreDeVigilancia(int numJugador):
    UnidadUniSeleccionable(numJugador)
{
    ...
    {
        throw Error::ExcepcionLocalizada("Interfaz::TorreDeVigilancia::TorreDeVigilancia()").Combinar(ex);
    }
}

//Destruye el modelo del cuartel general
TorreDeVigilancia::~TorreDeVigilancia()
{
    try
    {  
    }
...
void
TorreDeVigilancia::Actualizar()
{
}

//Obtiene el tipo de unidad
int
TorreDeVigilancia::GetTipo()
{
    return Red::Protocolo::Unidad::TorreDeVigilancia ;
}
...
TorreDeVigilancia::Inicializar()
{
    ...
    {
        throw Error::ExcepcionLocalizada("Interfaz::TorreDeVigilancia::Inicializar()").Combinar(ex);
    }
}
...
TorreDeVigilancia::Cerrar()
{
    ...
    {
        throw Error::ExcepcionLocalizada("Interfaz::TorreDeVigilancia::Cerrar()").Combinar(ex);
    }
}
